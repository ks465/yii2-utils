...
require_once __DIR__ . '/components/VarDump.php';
...
class Debug extends BaseObject
{
    ...
    {
        Debug::$varDump = new VarDump(null, null, null, new HulkHtmlVarDumpTheme());
        $variables = func_get_args();
        foreach ($variables as $variable) {
            Debug::$varDump->dump($variable);
        }
    }
    ...
    public static function vdc($variable, $recursiveDepth = null, $stringLength = null, $includeMethods = null,
        VarDumpTheme $theme = null)
    {
        Debug::$varDump = new VarDump($recursiveDepth, $stringLength, $includeMethods, $theme);
        Debug::$varDump->dump($variable);
    }
