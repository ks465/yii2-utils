 ...
 * @property string                   $tableTitle Title of the pages, which presumably is the comment of the database
 *     table.
...
class Generator extends \yii\gii\Generator
{
    ...
    public $modelClass;
    /**
     * @var string FQN for the generated controller class
     */
    ...
    /**
     * @var string type of generated view. It may be `grid` for grid view or `list` for list view.
     */
    public $indexWidgetType = 'grid';
    /**
     * @var string FQN for the generated search class
     */
    ...
    public $tableTitle;
    /**
     * @var string namespace for the data model classes
     */
    public $authForms = false;
    ...
    public function generate()
    {
        ...
        if (!empty($this->authForms) && $this->authForms !== false) {
