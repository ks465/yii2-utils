...
use khans\utils\tools\models\SysHistoryEmails;
use khans\utils\tools\models\queries\SysHistoryEmailsQuery;

/**
 * SysHistoryEmailsSearch represents the model behind the search form about `khans\utils\tools\models\SysHistoryEmails`.
 *
