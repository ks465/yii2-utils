 ...
 * @property string         $attr_label
 * @property string         $attr_type
 * @property string         $attr_length
 * @property string         $attr_scenario
 *
 ...
 * @since   1.0
 */
class SysEavAttributes extends \khans\utils\demos\data\KHanModel
{
    ...
    /**
     * {@inheritdoc}
     * @return SysEavAttributesQuery the active query used by this AR class.
     */
    public static function find(): \khans\utils\models\queries\KHanQuery
    {
        return new SysEavAttributesQuery(get_called_class());
    }
