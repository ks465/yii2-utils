...
use khans\utils\demos\data\SysEavAttributesQuery;

/**
 * SysEavAttributesSearch represents the model behind the search form about `\khans\utils\demos\data\SysEavAttributes`.
 *
