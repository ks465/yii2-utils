...
use khans\utils\demos\data\TestWorkflowEavSearch;
use yii\web\NotFoundHttpException;
use \yii\web\Response;
use yii\helpers\Html;

/**
 * TestWorkflowEavController implements the CRUD actions for TestWorkflowEvents model.
 *
 * @package khans\utils\generatedControllers
 * @version 0.3.1-980121
 * @since   1.0
 */
class TestWorkflowEavController extends KHanWebController
{
    /**
    ...
    {
        $searchModel = new TestWorkflowEavSearch();
    ...
    public function actionView($id)
    {
        ...
        if($request->isAjax){
            ...
            return [
                    'title'   => "Test Workflow Events with EAV #" . $model->title,
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            if($request->isGet){
                return [
                    'title'   => "افزودن به Test Workflow Events with EAV تازه",
                ...
                return [
                    ...
                    'title'       => "افزودن Test Workflow Events with EAV تازه",
                    'content'     => '<span class="text-success">افزودن Test Workflow Events with EAV موفق</span>',
                    'footer'      => Html::button('ببند', ['class' => 'btn btn-default pull-left','data-dismiss' => 'modal']).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'   => "ویرایش Test Workflow Events with EAV #" . $model->title,
                ...
                return [
                    'forceReload' => '#test-workflow-events-datatable-pjax',
                    'title'       => "Test Workflow Events with EAV #".$id,
                    'content'     => $this->renderAjax('view', [
                        'model' => $model,
                    ]),
                    'footer'      => Html::button('ببند', ['class' => 'btn btn-default pull-left', 'data-dismiss' => 'modal']).
                 ...
                 return [
                    'title'   => "ویرایش Test Workflow Events with EAV #".$id,
                    'content' =>$this->renderAjax('update', [
                        'model' => $model,
                    ]),
                    'footer'  => Html::button('ببند',['class' => 'btn btn-default pull-left', 'data-dismiss' => 'modal']).
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing TestWorkflowEvents model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     *
     * @param integer $id
