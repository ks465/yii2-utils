 ...
 * @since 1.0
 */
class UserTable extends KHanModel implements IdentityInterface
{
    ...
    /**
     * The user has leaved the duties in the site.
     * It is required only to reference older data.
     */
     ...
     */
    private static $_tableName = 'sys_users';

    /**
     *
     * @var string classname of the table for logging failed or successful login attempts
     */
    public static $_loginHistoryClass = 'khans\utils\tools\models\SysHistoryUsers';
    ...
    public static function findIdentityByAccessToken($token, $type = null)
    {
        ...
        // ]);
        // }
        // echo static::find()->where(['access_token' => $token, 'status' => self::STATUS_ACTIVE])->createCommand()->getRawSql();exit;;
    ...
    /**
     *
     * @return array list of self scenarios
     * @return array
     */
    public function scenarios(): array
    {
        return [
            ...
            'resetPassword' => [
                'password_hash',
                'access_token' /* 'password_reset_token' */
            ],
    ...
    {
        return $this->hasMany(SysHistoryUsers::class, [
            'user_id' => 'id'
        ])->andWhere([
            'user_table' => static::tableName()
        ]);
    }
}
