...
class KHanSUtilsComponentsMathHelper1Test extends \Codeception\Test\Unit
{
    /**
     * @var \UnitTester
     */
    ...
    public function testFloorBy3Step()
    {
        $step = 3;
        expect('default -1.00', MathHelper::floorBy(-1.00, $step))->equals(-3.0);
        expect('default -0.50', MathHelper::floorBy(-0.50, $step))->equals(-3.0);
        expect('default -0.35', MathHelper::floorBy(-0.01, $step))->equals(-3.0);

        expect('default 0.00', MathHelper::floorBy(0.00, $step))->equals(0.0);
        expect('default 0.45', MathHelper::floorBy(0.50, $step))->equals(0.0);

        expect('default 1.00', MathHelper::floorBy(1, $step))->equals(0.0);
        expect('default 1.45', MathHelper::floorBy(2, $step))->equals(0.0);
        expect('default 1.45', MathHelper::floorBy(3, $step))->equals(3.0);
        expect('default 1.45', MathHelper::floorBy(4, $step))->equals(3.0);
        expect('default 1.45', MathHelper::floorBy(5, $step))->equals(3.0);
        expect('default 1.45', MathHelper::floorBy(6, $step))->equals(6.0);
        expect('default 1.45', MathHelper::floorBy(7, $step))->equals(6.0);

        expect('default 1.50', MathHelper::floorBy(1.50, $step))->equals(0.0);
    ...
    public function testCeilBy3Step()
    {
        $step = 3;
        expect('default -1.00', MathHelper::ceilBy(-1.00, $step))->equals(0.0);
        expect('default -0.50', MathHelper::ceilBy(-0.50, $step))->equals(0.0);
        ...
        expect('default 0.00', MathHelper::ceilBy(0.00, $step))->equals(0.0);
        expect('default 0.05', MathHelper::ceilBy(0.50, $step))->equals(3.0);


        expect('default 1.00', MathHelper::ceilBy(1.00, $step))->equals(3.0);
        expect('default 1.45', MathHelper::ceilBy(1.45, $step))->equals(3.0);

        expect('default 1.50', MathHelper::ceilBy(1.50, $step))->equals(3.0);
        expect('default 1.50', MathHelper::ceilBy(1, $step))->equals(3.0);
        expect('default 1.50', MathHelper::ceilBy(2, $step))->equals(3.0);
        expect('default 1.50', MathHelper::ceilBy(3, $step))->equals(3.0);
        expect('default 1.50', MathHelper::ceilBy(4, $step))->equals(6.0);

        expect('default 15.40', MathHelper::ceilBy(15.40, $step))->equals(18.0);
    }
}
